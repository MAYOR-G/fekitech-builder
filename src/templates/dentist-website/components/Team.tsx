        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {team.map((member, index) => (
            <Reveal key={member.name} delay={index * 85}>
              <article className="group overflow-hidden rounded-[1.5rem] border border-bright-dental-ink/8 bg-bright-dental-porcelain shadow-card transition duration-300 hover:-translate-y-1 hover:shadow-soft">
                ...
                <div className="p-6">
                  <p className="text-xs font-bold uppercase tracking-[0.18em] text-bright-dental-ocean">
                    {member.role}
                  </p>
                  <h3 className="mt-2 font-bright-dental-display text-3xl font-semibold text-bright-dental-ink">
                    {member.name}
                  </h3>
