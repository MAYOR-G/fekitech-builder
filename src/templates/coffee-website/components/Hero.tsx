  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1500px] px-5 py-24 sm:px-8 lg:px-12 xl:px-20">
        ...
        >
          <p className="mb-7 flex items-center gap-3 text-[0.7rem] font-bold uppercase tracking-[0.26em] text-artisan-coffee-coffee-terracotta">
            <span className="h-px w-10 bg-artisan-coffee-coffee-terracotta/60" />
            {hero.eyebrow}
            <span className="h-px w-10 bg-artisan-coffee-coffee-terracotta/60" />
          </p>
          <h1 className="font-artisan-coffee-serif text-5xl font-bold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl xl:text-[5.5rem]">
