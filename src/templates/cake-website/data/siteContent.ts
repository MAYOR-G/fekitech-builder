...
export const brand = {
  ...
  tagline: "Beautiful cakes and celebration bakes, made to order in Bristol.",
  phone: "+44 117 555 0184",
  email: "hello@sweetdelightsbakery.co.uk",
  address: "18 Clifton Village, Bristol BS8 4AA",
  studioNote: "Private cake consultations and delivery across Bristol, Bath and the South West.",
  instagram: "@sweetdelightsbakery",
};

export const hero = {
  eyebrow: "Independent Bristol bakery",
  title: "Beautiful cakes for every celebration.",
  subtitle:
    "Made-to-order wedding cakes, birthday cakes and elegant bakes, created with exceptional ingredients and a careful eye for detail.",
  image: "/templates/assets/northmill-cakes-hero.webp",
  imageAlt: "Elegant tiered celebration cake with berries, chocolate and matching cupcakes",
  primaryLabel: "Plan your cake",
  primaryHref: "#order",
  secondaryLabel: "View our cakes",
  secondaryHref: "#gallery",
  note: "Wedding · birthday · celebration",
};
