        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[...gallery.rowOne, ...gallery.rowTwo].map((img, i) => (
            <div key={i} className="relative aspect-[16/9] bg-[#111111] overflow-hidden group">
              <img src={img.image} alt={img.imageAlt} className="w-full h-full object-cover mix-blend-luminosity opacity-80 group-hover:mix-blend-normal group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" />
