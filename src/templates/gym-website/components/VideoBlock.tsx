...
const VideoBlock = () => {
  return (
    <section className="py-24 bg-iron-gym-gym-charcoal">
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative rounded-3xl overflow-hidden aspect-video group">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
            <h3 className="text-3xl md:text-5xl font-black font-iron-gym-display uppercase tracking-tighter text-white">Experience The Studio</h3>
          </div>
        </div>
      </div>
    </section>
