...
const StickyBackground = () => {
  return (
    <section className="relative z-0 h-[60vh] md:h-[80vh] w-full overflow-hidden">
      <div className="absolute inset-0 bg-iron-gym-gym-darker/60 z-10"></div>
      <TemplateImage
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-6">
        <h2 className="text-5xl md:text-7xl font-black font-iron-gym-display uppercase tracking-tighter mb-6 text-white text-shadow">
          Dedication <br />
          <span className="text-iron-gym-gym-accent">Over Motivation.</span>
        </h2>
